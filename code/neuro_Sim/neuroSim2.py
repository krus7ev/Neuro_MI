...
#calculate mean MI and std.dev from samples at each delay point
MI_2_0_avg = []
MI_2_0_std = []
...
plt.ylabel('$Mutual$ $information$ $I(n_2;n_0)$', fontsize=23)
plt.xlabel('$Poisson$ $spikes$ $delay$ $[s]$', fontsize=23)
plt.show()
