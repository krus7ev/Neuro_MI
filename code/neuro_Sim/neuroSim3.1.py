...
trials  = 36           # number of simulation rounds in each experiment
rounds  = 12
...
for d in range(-d_luft, d_luft+1) :
  d *= d_bin
# generate data and estimate information multiple rounds at each delay
  MI_d = []
